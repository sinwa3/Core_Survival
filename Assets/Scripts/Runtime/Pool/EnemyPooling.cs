...
public class EnemyPooling : MonoBehaviour
{
    ...
    private TempEnemy GetEnemy(Vector3 pos, Quaternion rot)
    {
    ...
    private void ReturnEnemy(TempEnemy enemy)
    {
        if (enemy == null)
        {
            Debug.LogWarning("반환 불가 / null인 적");
