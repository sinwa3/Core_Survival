...
| **개발 기간 / 인원** | 2026.08.24 ~ 09.11 (약 3.5주) / 1인 |
| **플랫폼** | PC (Windows) |
...
숫자 하나가 일찍 사라지는 것은 아무도 알아채지 못하기 때문입니다.
...
애초에 여유가 있었기 때문입니다. 이 규모에서는 병목이 아니었다는 것이 정확한 서술입니다.
...
## ⚠️ 저장소 상태 — 클론해도 실행되지 않습니다

라이선스 문제로 **유료/외부 에셋 5종을 저장소에서 제외**했습니다.
